...
public class AccUI implements ActionListener
{
	...
	public void actionPerformed( ActionEvent ev ){
		...
		{
			try{
				String s_num1 = tf_sendAccNum.getText();			
				String r_num2 = tf_recvAccNum.getText();
				int money = Integer.parseInt(tf_moveMoney.getText());
				
				int result = logic.moveAccount(s_num1, r_num2, money);
			...
			////////////////////////////////////////////////////////
			// 1. 화면에서 입력값 얻어오기
			// 2. Business Logic 객체 생성 ( ex. AccLogic ) 맨위에 생성자에 했음
